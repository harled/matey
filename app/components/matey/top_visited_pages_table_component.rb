class Matey::TopVisitedPagesTableComponent < ApplicationComponent
    def initialize(events:, time_window: 1.week, number_of_events: 10)    
        ...
        @user_count_by_event = @user_count_by_event.sort_by { |controller_name_and_action, count| count }.last(number_of_events).reverse
